...
class Locations(LocationTypeEnum):
    ...
    OS_MUSIC_HALL_WONDER_WILLIS_TRINKET = (
        "OS Music Hall Wonder Willis Trinket",148,Regions.OSSEX_MUSIC_HALL,CanCarry() & CanBurrow() & CanSwim() & CanClimb(),
    )
...
class BossLocations(LocationTypeEnum):
    OS_DEFEAT_ARMOND = ("OS Defeat Armond", 1021, Regions.OSSEX_LEGOVICHS_ARMS_BASEMENT)
    OS_DEFEAT_EVRA = ("OS Defeat Evra", 1022, Regions.OSSEX_GODDREDS_GRAVE_ARENA)
    OS_DEFEAT_WILLY = ("OS Defeat Willy", 1020, Regions.OSSEX_MUSIC_HALL, CanCarry() & CanBurrow() & CanSwim() & CanClimb())