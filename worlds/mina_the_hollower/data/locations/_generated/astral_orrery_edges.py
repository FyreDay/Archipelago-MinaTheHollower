...
class RegionConnections(ConnectionTypeEnum):
    ASTRAL_ORRERY_BAYOU_MIRROR_ASTRAL_ORRERY_MIRROR_S_END = ("Astral Orrery Bayou Mirror_Astral Orrery Mirror's End", Regions.ASTRAL_ORRERY_BAYOU_MIRROR, Regions.ASTRAL_ORRERY_MIRROR_S_END, Has(AstralPlatforms.GREEN_ASTRAL_PLATFORMS.value)),
    ASTRAL_ORRERY_BONE_BEACH_MIRROR_ASTRAL_ORRERY_MIRROR_S_END = ("Astral Orrery Bone Beach Mirror_Astral Orrery Mirror's End", Regions.ASTRAL_ORRERY_BONE_BEACH_MIRROR, Regions.ASTRAL_ORRERY_MIRROR_S_END, Has(AstralPlatforms.RED_ASTRAL_PLATFORMS.value)),
    ASTRAL_ORRERY_COLTRANE_PEAK_MIRROR_ASTRAL_ORRERY_MIRROR_S_END = ("Astral Orrery Coltrane Peak Mirror_Astral Orrery Mirror's End", Regions.ASTRAL_ORRERY_COLTRANE_PEAK_MIRROR, Regions.ASTRAL_ORRERY_MIRROR_S_END, Has(AstralPlatforms.PURPLE_ASTRAL_PLATFORMS.value)),
    ASTRAL_ORRERY_MIRROR_S_END_BLUE_STAIRS_ASTRAL_ORRERY_MIRROR_S_END = ("Astral Orrery Mirror's End Blue Stairs_Astral Orrery Mirror's End", Regions.ASTRAL_ORRERY_MIRROR_S_END_BLUE_STAIRS, Regions.ASTRAL_ORRERY_MIRROR_S_END, Has(AstralPlatforms.BLUE_ASTRAL_PLATFORMS.value) | CanJumpTiles(distance=5, has_wall=True)),
    ASTRAL_ORRERY_MIRROR_S_END_MOVING_PLATFORMS_ASTRAL_ORRERY_MIRROR_S_END_MOVING_STAIRS = ("Astral Orrery Mirror's End Moving Platforms_Astral Orrery Mirror's End Moving Stairs", Regions.ASTRAL_ORRERY_MIRROR_S_END_MOVING_PLATFORMS, Regions.ASTRAL_ORRERY_MIRROR_S_END_MOVING_STAIRS, CanBurrow() | CanJumpTiles(distance=2)),
    ASTRAL_ORRERY_MIRROR_S_END_MOVING_STAIRS_ASTRAL_ORRERY_MIRROR_S_END_MOVING_PLATFORMS = ("Astral Orrery Mirror's End Moving Stairs_Astral Orrery Mirror's End Moving Platforms", Regions.ASTRAL_ORRERY_MIRROR_S_END_MOVING_STAIRS, Regions.ASTRAL_ORRERY_MIRROR_S_END_MOVING_PLATFORMS, CanClimb() | CanBurrow() | CanJumpTiles(distance=2)),
    ASTRAL_ORRERY_MIRROR_S_END_TOP_ASTRAL_ORRERY_MIRROR_S_END = ("Astral Orrery Mirror's End Top_Astral Orrery Mirror's End", Regions.ASTRAL_ORRERY_MIRROR_S_END_TOP, Regions.ASTRAL_ORRERY_MIRROR_S_END, CanBurrow() & AnyThreeAstralPlatforms()),
    ASTRAL_ORRERY_MIRROR_S_END_ASTRAL_ORRERY_MIRROR_S_END_BLUE_STAIRS = ("Astral Orrery Mirror's End_Astral Orrery Mirror's End Blue Stairs", Regions.ASTRAL_ORRERY_MIRROR_S_END, Regions.ASTRAL_ORRERY_MIRROR_S_END_BLUE_STAIRS, Has(AstralPlatforms.BLUE_ASTRAL_PLATFORMS.value) | CanJumpTiles(distance=5, has_wall=True)),
    ASTRAL_ORRERY_MIRROR_S_END_ASTRAL_ORRERY_MIRROR_S_END_TOP = ("Astral Orrery Mirror's End_Astral Orrery Mirror's End Top", Regions.ASTRAL_ORRERY_MIRROR_S_END, Regions.ASTRAL_ORRERY_MIRROR_S_END_TOP, CanBurrow() & AnyThreeAstralPlatforms()),
    ASTRAL_ORRERY_QUEENSBURY_MIRROR_ASTRAL_ORRERY_MIRROR_S_END = ("Astral Orrery Queensbury Mirror_Astral Orrery Mirror's End", Regions.ASTRAL_ORRERY_QUEENSBURY_MIRROR, Regions.ASTRAL_ORRERY_MIRROR_S_END, Has(AstralPlatforms.BLUE_ASTRAL_PLATFORMS.value)),
    ASTRAL_ORRERY_SEPTEMBURG_MIRROR_ASTRAL_ORRERY_MIRROR_S_END = ("Astral Orrery Septemburg Mirror_Astral Orrery Mirror's End", Regions.ASTRAL_ORRERY_SEPTEMBURG_MIRROR, Regions.ASTRAL_ORRERY_MIRROR_S_END, Has(AstralPlatforms.YELLOW_ASTRAL_PLATFORMS.value)),
...
class RegionTransitions(TransitionTypeEnum):
    ASTRAL_ORRERY_BAYOU_MIRROR = ('Astral Orrery Bayou Mirror', Regions.ASTRAL_ORRERY_BAYOU_MIRROR, Regions.NOX_S_BAYOU_MOONLIT_MIRROR, DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    ...
    ASTRAL_ORRERY_MIRROR_S_END_BLUE_CHEST_SOUTH_TRANSITION = ("Astral Orrery Mirror's End Blue Chest South Transition", Regions.ASTRAL_ORRERY_MIRROR_S_END_BLUE_CHEST, Regions.ASTRAL_ORRERY_MIRROR_S_END_BLUE_STAIRS, DirectionType.SOUTH, TransitionType.SCREENS, True_()),
    ASTRAL_ORRERY_MIRROR_S_END_BLUE_STAIRS_NORTH_TRANSITION = ("Astral Orrery Mirror's End Blue Stairs North Transition", Regions.ASTRAL_ORRERY_MIRROR_S_END_BLUE_STAIRS, Regions.ASTRAL_ORRERY_MIRROR_S_END_BLUE_CHEST, DirectionType.NORTH, TransitionType.SCREENS, True_()),
    ASTRAL_ORRERY_MIRROR_S_END_EAST_PURPLE_BURROW = ("Astral Orrery Mirror's End East Purple Burrow", Regions.ASTRAL_ORRERY_COLTRANE_PEAK_MIRROR, Regions.ASTRAL_ORRERY_UNDER_COLTRANE_PEAK_MIRROR, DirectionType.EAST, TransitionType.BURROW, (Has(AstralPlatforms.PURPLE_ASTRAL_PLATFORMS.value) | CanJumpTiles(distance=5, has_wall=True)) & CanBurrow()),
    ASTRAL_ORRERY_MIRROR_S_END_EAST_RED_BURROW = ("Astral Orrery Mirror's End East Red Burrow", Regions.ASTRAL_ORRERY_MIRROR_S_END, Regions.ASTRAL_ORRERY_MIRROR_S_END_UNDER_RED_SWITCH, DirectionType.EAST, TransitionType.BURROW, Has(AstralPlatforms.RED_ASTRAL_PLATFORMS.value) & CanBurrow()),
    ASTRAL_ORRERY_MIRROR_S_END_LARGE_MIRROR = ("Astral Orrery Mirror's End Large Mirror", Regions.ASTRAL_ORRERY_MIRROR_S_END, Regions.RADIANT_MANOR_FOYER, DirectionType.ASTRAL, TransitionType.MIRRORS, True_()),
    ASTRAL_ORRERY_MIRROR_S_END_MOVING_PLATFORMS_SOUTH_BURROW = ("Astral Orrery Mirror's End Moving Platforms South Burrow", Regions.ASTRAL_ORRERY_MIRROR_S_END_MOVING_PLATFORMS, Regions.ASTRAL_ORRERY_MIRROR_S_END_TOP, DirectionType.SOUTH, TransitionType.BURROW, True_()),
    ASTRAL_ORRERY_MIRROR_S_END_MOVING_STAIRS_STAIRS = ("Astral Orrery Mirror's End Moving Stairs Stairs", Regions.ASTRAL_ORRERY_MIRROR_S_END_MOVING_STAIRS, Regions.ASTRAL_ORRERY_STELLARIUM, DirectionType.NORTH, TransitionType.STAIRS, True_()),
    ASTRAL_ORRERY_MIRROR_S_END_RED_CHEST_WEST_BURROW = ("Astral Orrery Mirror's End Red Chest West Burrow", Regions.ASTRAL_ORRERY_MIRROR_S_END_RED_CHEST, Regions.ASTRAL_ORRERY_MIRROR_S_END_UNDER_RED_SWITCH, DirectionType.WEST, TransitionType.BURROW, Has(AstralPlatforms.RED_ASTRAL_PLATFORMS.value) & CanBurrow()),
    ASTRAL_ORRERY_MIRROR_S_END_TOP_NORTH_BURROW = ("Astral Orrery Mirror's End Top North Burrow", Regions.ASTRAL_ORRERY_MIRROR_S_END_TOP, Regions.ASTRAL_ORRERY_MIRROR_S_END_MOVING_PLATFORMS, DirectionType.NORTH, TransitionType.BURROW, True_()),
    ASTRAL_ORRERY_MIRROR_S_END_UNDER_RED_SWITCH_BURROW_WEST = ("Astral Orrery Mirror's End Under Red Switch Burrow West", Regions.ASTRAL_ORRERY_MIRROR_S_END_UNDER_RED_SWITCH, Regions.ASTRAL_ORRERY_MIRROR_S_END, DirectionType.WEST, TransitionType.BURROW, Has(AstralPlatforms.RED_ASTRAL_PLATFORMS.value) & CanBurrow()),
    ASTRAL_ORRERY_MIRROR_S_END_UNDER_RED_SWITCH_EAST_BURROW = ("Astral Orrery Mirror's End Under Red Switch East Burrow", Regions.ASTRAL_ORRERY_MIRROR_S_END_UNDER_RED_SWITCH, Regions.ASTRAL_ORRERY_MIRROR_S_END_RED_CHEST, DirectionType.EAST, TransitionType.BURROW, Has(AstralPlatforms.RED_ASTRAL_PLATFORMS.value) & CanBurrow()),
    ...
    ASTRAL_ORRERY_STELLARIUM_STAIRS = ('Astral Orrery Stellarium Stairs', Regions.ASTRAL_ORRERY_STELLARIUM, Regions.ASTRAL_ORRERY_MIRROR_S_END_MOVING_STAIRS, DirectionType.NORTH, TransitionType.STAIRS, True_()),
