...
class RegionConnections(ConnectionTypeEnum):
    ...
    ASTRAL_ORRERY_MIRRORS_END_ASTRAL_ORRERY_BAYOU_MIRROR = ("Astral Orrery Mirror's End_Astral Orrery Bayou Mirror", Regions.ASTRAL_ORRERY_MIRRORS_END, Regions.ASTRAL_ORRERY_BAYOU_MIRROR, Has(AstralPlatforms.GREEN_ASTRAL_PLATFORMS.value))
    ASTRAL_ORRERY_MIRRORS_END_ASTRAL_ORRERY_BONE_BEACH_MIRROR = ("Astral Orrery Mirror's End_Astral Orrery Bone Beach Mirror", Regions.ASTRAL_ORRERY_MIRRORS_END, Regions.ASTRAL_ORRERY_BONE_BEACH_MIRROR, Has(AstralPlatforms.RED_ASTRAL_PLATFORMS.value))
    ...
    ASTRAL_ORRERY_MIRRORS_END_ASTRAL_ORRERY_QUEENSBURY_MIRROR = ("Astral Orrery Mirror's End_Astral Orrery Queensbury Mirror", Regions.ASTRAL_ORRERY_MIRRORS_END, Regions.ASTRAL_ORRERY_QUEENSBURY_MIRROR, Has(AstralPlatforms.BLUE_ASTRAL_PLATFORMS.value))
    ASTRAL_ORRERY_MIRRORS_END_ASTRAL_ORRERY_SEPTEMBURG_MIRROR = ("Astral Orrery Mirror's End_Astral Orrery Septemburg Mirror", Regions.ASTRAL_ORRERY_MIRRORS_END, Regions.ASTRAL_ORRERY_SEPTEMBURG_MIRROR, Has(AstralPlatforms.YELLOW_ASTRAL_PLATFORMS.value))
