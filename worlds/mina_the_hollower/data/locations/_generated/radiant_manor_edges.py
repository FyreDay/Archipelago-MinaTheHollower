...
class RegionTransitions(TransitionTypeEnum):
    ...
    RADIANT_MANOR_BALLROOM_MEOWSTRO_DOORS = ('Radiant Manor Ballroom Meowstro Doors', Regions.RADIANT_MANOR_BALLROOM, Regions.RADIANT_MANOR_MEOWSTRO_S_CHAMBER, DirectionType.NORTH, TransitionType.DOORS, RepairedGeneratorCount(count=6)),
    ...
    RADIANT_MANOR_FOYER_BUTLER_S_DOORS = ("Radiant Manor Foyer Butler's Doors", Regions.RADIANT_MANOR_FOYER, Regions.RADIANT_MANOR_FOYER_BUTLERS_OFFICE, DirectionType.NORTH, TransitionType.DOORS, True_()),
    ...
    RADIANT_MANOR_FOYER_MIRROR = ('Radiant Manor Foyer Mirror', Regions.RADIANT_MANOR_FOYER, Regions.ASTRAL_ORRERY_MIRROR_S_END, DirectionType.OVERWORLD, TransitionType.MIRRORS, True_()),
    ...
    RADIANT_MANOR_GALLERY_RIGHT_EAST_TRANSITION = ('Radiant Manor Gallery Right East Transition', Regions.RADIANT_MANOR_GALLERY_RIGHT, Regions.RADIANT_MANOR_SERVANT_S_QUARTERS, DirectionType.EAST, TransitionType.SCREENS, True_()),
    ...
    RADIANT_MANOR_MEOWSTRO_S_CHAMBER_DOORS = ("Radiant Manor Meowstro's Chamber Doors", Regions.RADIANT_MANOR_MEOWSTRO_S_CHAMBER, Regions.RADIANT_MANOR_BALLROOM, DirectionType.NORTH, TransitionType.DOORS, RepairedGeneratorCount(count=6)),
    ...
    RADIANT_MANOR_ROOFTOP_LEDGE_STAIRS = ('Radiant Manor Rooftop Ledge Stairs', Regions.RADIANT_MANOR_ROOFTOP_LEDGE, Regions.RADIANT_MANOR_SERVANT_S_ARENA, DirectionType.NORTH, TransitionType.STAIRS, True_()),
    ...
    RADIANT_MANOR_SERVANT_S_ARENA_SOUTH_TRANSITION = ("Radiant Manor Servant's Arena South Transition", Regions.RADIANT_MANOR_SERVANT_S_ARENA, Regions.RADIANT_MANOR_SERVANT_S_QUARTERS, DirectionType.SOUTH, TransitionType.SCREENS, PowerLevelThreshold(power=40)),
    RADIANT_MANOR_SERVANT_S_ARENA_STAIRS = ("Radiant Manor Servant's Arena Stairs", Regions.RADIANT_MANOR_SERVANT_S_ARENA, Regions.RADIANT_MANOR_ROOFTOP_LEDGE, DirectionType.NORTH, TransitionType.STAIRS, PowerLevelThreshold(power=40)),
    RADIANT_MANOR_SERVANT_S_QUARTERS_NORTH_TRANSITION = ("Radiant Manor Servant's Quarters North Transition", Regions.RADIANT_MANOR_SERVANT_S_QUARTERS, Regions.RADIANT_MANOR_SERVANT_S_ARENA, DirectionType.NORTH, TransitionType.SCREENS, True_()),
    RADIANT_MANOR_SERVANT_S_QUARTERS_WEST_TRANSITION = ("Radiant Manor Servant's Quarters West Transition", Regions.RADIANT_MANOR_SERVANT_S_QUARTERS, Regions.RADIANT_MANOR_GALLERY_RIGHT, DirectionType.WEST, TransitionType.SCREENS, True_()),
