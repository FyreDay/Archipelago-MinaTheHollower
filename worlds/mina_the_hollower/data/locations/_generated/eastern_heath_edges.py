...
class RegionConnections(ConnectionTypeEnum):
    ...
    EASTERN_HEATH_BUCKLERS_BLUFF_CLIFF_EASTERN_HEATH_BUCKLERS_BLUFF_START = ("Eastern Heath Buckler's Bluff Cliff_Eastern Heath Buckler's Bluff Start", Regions.EASTERN_HEATH_BUCKLERS_BLUFF_CLIFF, Regions.EASTERN_HEATH_BUCKLERS_BLUFF_START, CanJumpTiles(distance=4, has_wall=True))
    EASTERN_HEATH_BUCKLERS_BLUFF_START_EASTERN_HEATH_BUCKLERS_BLUFF_CLIFF = ("Eastern Heath Buckler's Bluff Start_Eastern Heath Buckler's Bluff Cliff", Regions.EASTERN_HEATH_BUCKLERS_BLUFF_START, Regions.EASTERN_HEATH_BUCKLERS_BLUFF_CLIFF, CanJumpTiles(distance=4, has_wall=True))
...
class RegionTransitions(TransitionTypeEnum):
    EASTERN_HEATH_BUCKLERS_BLUFF_BUCKLERS_WEST_TRANSITION = ("Eastern Heath Buckler's Bluff Bucklers West Transition", Regions.EASTERN_HEATH_BUCKLERS_BLUFF_BUCKLERS, Regions.EASTERN_HEATH_GRASSLAND_WATERFALL_SECOND_LEVEL, DirectionType.WEST, TransitionType.SCREENS, True_())
    EASTERN_HEATH_BUCKLERS_BLUFF_START_SOUTH_KEAR_BURROW = ("Eastern Heath Buckler's Bluff Start South Kear Burrow", Regions.EASTERN_HEATH_BUCKLERS_BLUFF_START, Regions.EASTERN_HEATH_MOURNERS_GATE, DirectionType.SOUTH, TransitionType.BURROW, CanBurrow() & HasKear(kear=SingleKears.EASTERN_HEATH_BUCKLERS_BLUFF_KEAR.value))
    EASTERN_HEATH_BUCKLERS_BLUFF_START_SOUTH_TRANSITION = ("Eastern Heath Buckler's Bluff Start South Transition", Regions.EASTERN_HEATH_BUCKLERS_BLUFF_START, Regions.EASTERN_HEATH_MOURNERS_GATE, DirectionType.SOUTH, TransitionType.SCREENS, True_())
    ...
    EASTERN_HEATH_GRASSLAND_WATERFALL_SECOND_LEVEL_EAST_TRANSITION = ('Eastern Heath Grassland Waterfall Second Level East Transition', Regions.EASTERN_HEATH_GRASSLAND_WATERFALL_SECOND_LEVEL, Regions.EASTERN_HEATH_BUCKLERS_BLUFF_BUCKLERS, DirectionType.EAST, TransitionType.SCREENS, True_())
    ...
    EASTERN_HEATH_MOURNERS_GATE_EAST_AREA_TRANSITION = ('Eastern Heath Mourners Gate East Area Transition', Regions.EASTERN_HEATH_MOURNERS_GATE, Regions.MOURNERS_MILE_KNIGHTS_REST_MAIN, DirectionType.EAST, TransitionType.AREA_SCREENS, True_())
    EASTERN_HEATH_MOURNERS_GATE_NORTH_KEAR_BURROW = ('Eastern Heath Mourners Gate North Kear Burrow', Regions.EASTERN_HEATH_MOURNERS_GATE, Regions.EASTERN_HEATH_BUCKLERS_BLUFF_START, DirectionType.NORTH, TransitionType.BURROW, CanBurrow() & HasKear(kear=SingleKears.EASTERN_HEATH_BUCKLERS_BLUFF_KEAR.value))
