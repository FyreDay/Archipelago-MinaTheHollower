...
class RegionConnections(ConnectionTypeEnum):
    ...
    KINDLEWOOD_WALLOWERS_PATH_KINDLEWOOD_WALLOWERS_PATH_CLIFF_BUSH = ("Kindlewood Wallowers Path_Kindlewood Wallower's Path Cliff Bush", Regions.KINDLEWOOD_WALLOWERS_PATH, Regions.KINDLEWOOD_WALLOWERS_PATH_CLIFF_BUSH, CanBurrow())
...
class RegionTransitions(TransitionTypeEnum):
    ...
    KINDLEWOOD_OVERGROWTH_BONFIRE_LEFT_WEST_BURROW = ('Kindlewood Overgrowth Bonfire Left West Burrow', Regions.KINDLEWOOD_OVERGROWTH_BONFIRE_LEFT, Regions.KINDLEWOOD_WALLOWERS_PATH_CLIFF_BUSH, DirectionType.WEST, TransitionType.BURROW, CanBurrow())
    ...
    KINDLEWOOD_SCHOOL_SIDE_EAST_BURROW = ('Kindlewood School Side East Burrow', Regions.KINDLEWOOD_SCHOOL_SIDE, Regions.KINDLEWOOD_SCHOOL, DirectionType.EAST, TransitionType.BURROW, CanBurrow())
    KINDLEWOOD_SCHOOL_WEST_BURROW = ('Kindlewood School West Burrow', Regions.KINDLEWOOD_SCHOOL, Regions.KINDLEWOOD_SCHOOL_SIDE, DirectionType.WEST, TransitionType.BURROW, CanBurrow())
