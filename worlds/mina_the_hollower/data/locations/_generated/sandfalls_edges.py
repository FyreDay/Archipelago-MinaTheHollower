...
class RegionTransitions(TransitionTypeEnum):
    ...
    SANDFALLS_BONE_JUNCTION_PLANK_WEST_AREA_TRANSITION = ('Sandfalls Bone Junction Plank West Area Transition', Regions.SANDFALLS_BONE_JUNCTION_PLANK, Regions.MOURNER_S_MILE_SPIKE_HELL_SANDFALL, DirectionType.WEST, TransitionType.AREA_SCREENS, True_()),
    ...
    SANDFALLS_SANDWATER_JUNCTION_SOUTH_ROPE = ('Sandfalls Sandwater Junction South Rope', Regions.SANDFALLS_SANDWATER_JUNCTION, Regions.LONER_S_LANDING_BOARDWALK_SANDFALLS_LEDGE, DirectionType.SOUTH, TransitionType.SCREENS, CanClimb()),
    SANDFALLS_SANDWATER_JUNCTION_SOUTH_TRANSITION = ('Sandfalls Sandwater Junction South Transition', Regions.SANDFALLS_SANDWATER_JUNCTION, Regions.LONER_S_LANDING_BOARDWALK_SANDFALLS_LAKE, DirectionType.SOUTH, TransitionType.SCREENS, True_()),
