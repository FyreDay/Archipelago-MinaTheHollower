...
class RegionTransitions(TransitionTypeEnum):
    ...
    OSSEX_CITY_CENTER_MAIN_COUPLE_S_QUARTER_DOOR = ("Ossex City Center Main Couple's Quarter Door", Regions.OSSEX_CITY_CENTER_MAIN, Regions.OSSEX_COUPLE_S_QUARTER, DirectionType.NORTH, TransitionType.DOORS, True_()),
    ...
    OSSEX_CITY_CENTER_MAIN_LEGOVICH_S_ARMS_DOOR = ("Ossex City Center Main Legovich's Arms Door", Regions.OSSEX_CITY_CENTER_MAIN, Regions.OSSEX_LEGOVICH_S_ARMS, DirectionType.NORTH, TransitionType.DOORS, True_()),
    ...
    OSSEX_CITY_CENTER_MAIN_PAWNTY_S_EXCHANGE_DOOR = ("Ossex City Center Main Pawnty's Exchange Door", Regions.OSSEX_CITY_CENTER_MAIN, Regions.OSSEX_PAWNTY_EXCHANGE, DirectionType.NORTH, TransitionType.DOORS, True_()),
    ...
    OSSEX_COUPLE_S_QUARTER_EXIT = ("Ossex Couple's Quarter Exit", Regions.OSSEX_COUPLE_S_QUARTER, Regions.OSSEX_CITY_CENTER_MAIN, DirectionType.SOUTH, TransitionType.DOORS, True_()),
    ...
    OSSEX_COURTYARD_EAST_MANOR_SIDE_GARDEN_GEYSER_DROP = ('Ossex Courtyard East Manor Side Garden Geyser Drop', Regions.OSSEX_COURTYARD_EAST_MANOR_SIDE_GARDEN, Regions.OSSEX_GODDRED_S_GRAVE, DirectionType.OVERWORLD, TransitionType.GEYSER_DOWN, True_()),
    ...
    OSSEX_GODDRED_S_GRAVE_ARENA_NORTH_TRANSITION = ("Ossex Goddred's Grave Arena North Transition", Regions.OSSEX_GODDRED_S_GRAVE_ARENA, Regions.OSSEX_GODDRED_S_GRAVE_END, DirectionType.NORTH, TransitionType.SCREENS, PowerLevelThreshold(power=40)),
    OSSEX_GODDRED_S_GRAVE_ARENA_SOUTH_TRANSITION = ("Ossex Goddred's Grave Arena South Transition", Regions.OSSEX_GODDRED_S_GRAVE_ARENA, Regions.OSSEX_GODDRED_S_GRAVE_HALL, DirectionType.SOUTH, TransitionType.SCREENS, PowerLevelThreshold(power=40)),
    OSSEX_GODDRED_S_GRAVE_EAST_TRANSITION = ("Ossex Goddred's Grave East Transition", Regions.OSSEX_GODDRED_S_GRAVE, Regions.OSSEX_GODDRED_S_GRAVE_HALL, DirectionType.EAST, TransitionType.SCREENS, True_()),
    OSSEX_GODDRED_S_GRAVE_END_SOUTH_TRANSITION = ("Ossex Goddred's Grave End South Transition", Regions.OSSEX_GODDRED_S_GRAVE_END, Regions.OSSEX_GODDRED_S_GRAVE_ARENA, DirectionType.SOUTH, TransitionType.SCREENS, True_()),
    OSSEX_GODDRED_S_GRAVE_END_TUBE = ("Ossex Goddred's Grave End Tube", Regions.OSSEX_GODDRED_S_GRAVE_END, Regions.OSSEX_GODDRED_S_GRAVE_HALL, DirectionType.OVERWORLD, TransitionType.DO_NOT_RANDOMIZE_ENTRANCE, CanBurrow()),
    OSSEX_GODDRED_S_GRAVE_GEYSER_EXIT = ("Ossex Goddred's Grave Geyser Exit", Regions.OSSEX_GODDRED_S_GRAVE, Regions.OSSEX_COURTYARD_EAST_MANOR_SIDE_GARDEN, DirectionType.OVERWORLD, TransitionType.GEYSER_UP, True_()),
    OSSEX_GODDRED_S_GRAVE_HALL_NORTH_TRANSITION = ("Ossex Goddred's Grave Hall North Transition", Regions.OSSEX_GODDRED_S_GRAVE_HALL, Regions.OSSEX_GODDRED_S_GRAVE_ARENA, DirectionType.NORTH, TransitionType.SCREENS, PowerLevelThreshold(power=40)),
    OSSEX_GODDRED_S_GRAVE_HALL_WEST_TRANSITION = ("Ossex Goddred's Grave Hall West Transition", Regions.OSSEX_GODDRED_S_GRAVE_HALL, Regions.OSSEX_GODDRED_S_GRAVE, DirectionType.WEST, TransitionType.SCREENS, True_()),
    ...
    OSSEX_LEGOVICH_S_ARMS_BASEMENT_GEYSER_UP = ("Ossex Legovich's Arms Basement Geyser Up", Regions.OSSEX_LEGOVICH_S_ARMS_BASEMENT, Regions.OSSEX_LEGOVICH_S_ARMS, DirectionType.NORTH, TransitionType.GEYSER_UP, True_()),
    OSSEX_LEGOVICH_S_ARMS_EXIT = ("Ossex Legovich's Arms Exit", Regions.OSSEX_LEGOVICH_S_ARMS, Regions.OSSEX_CITY_CENTER_MAIN, DirectionType.SOUTH, TransitionType.DOORS, True_()),
    OSSEX_LEGOVICH_S_ARMS_GEYSER_DROP = ("Ossex Legovich's Arms Geyser Drop", Regions.OSSEX_LEGOVICH_S_ARMS, Regions.OSSEX_LEGOVICH_S_ARMS_BASEMENT, DirectionType.SOUTH, TransitionType.GEYSER_DOWN, True_()),
