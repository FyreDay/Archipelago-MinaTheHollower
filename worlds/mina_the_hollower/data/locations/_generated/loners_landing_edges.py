...
class RegionConnections(ConnectionTypeEnum):
    ...
    LONERS_LANDING_BLIGHTED_DOCKS_BRIDGE_CLIFF_LONERS_LANDING_BLIGHTED_DOCKS_BRIDGE = ("Loner's Landing Blighted Docks Bridge Cliff_Loner's Landing Blighted Docks Bridge", Regions.LONERS_LANDING_BLIGHTED_DOCKS_BRIDGE_CLIFF, Regions.LONERS_LANDING_BLIGHTED_DOCKS_BRIDGE, CanClimb() & (CanBounce() | CanJumpTiles(distance=3)))
...
class RegionTransitions(TransitionTypeEnum):
    ...
    LONERS_LANDING_BLIGHTED_DOCKS_BRIDGE_EAST_TRANSITION = ("Loner's Landing Blighted Docks Bridge East Transition", Regions.LONERS_LANDING_BLIGHTED_DOCKS_BRIDGE, Regions.LONERS_LANDING_BLIGHTED_DOCKS_ROAD_UPPER, DirectionType.EAST, TransitionType.SCREENS, CanBounce())
