...
class RegionTransitions(TransitionTypeEnum):
    ...
    BACKWATERS_BAYOU_FALLS_WEST_AREA_TRANSITION = ('Backwaters Bayou Falls West Area Transition', Regions.BACKWATERS_BAYOU_FALLS_WEST, Regions.NOX_S_BAYOU_BOAT_STATION_PATH, DirectionType.WEST, TransitionType.AREA_SCREENS, True_()),
    ...
    BACKWATERS_LOWER_SWAMP_BAYOU_ENTRANCE_LUCKY_BURROW = ('Backwaters Lower Swamp Bayou Entrance Lucky Burrow', Regions.BACKWATERS_LOWER_SWAMP_BAYOU_ENTRANCE, Regions.BACKWATERS_LUCKY_S_LAIR, DirectionType.NORTH, TransitionType.BURROW, CanBurrow()),
    ...
    BACKWATERS_LOWER_SWAMP_STATION_SOUTH_AREA_TRANSITION = ('Backwaters Lower Swamp Station South Area Transition', Regions.BACKWATERS_LOWER_SWAMP_STATION, Regions.LONER_S_LANDING_BAY, DirectionType.SOUTH, TransitionType.AREA_SCREENS, True_()),
    ...
    BACKWATERS_LUCKY_S_LAIR_BURROW_EXIT = ("Backwaters Lucky's Lair Burrow Exit", Regions.BACKWATERS_LUCKY_S_LAIR, Regions.BACKWATERS_LOWER_SWAMP_BAYOU_ENTRANCE, DirectionType.SOUTH, TransitionType.BURROW, CanBurrow()),
